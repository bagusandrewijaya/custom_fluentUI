  ...
  Widget build(
    ...
    final button = HoverButton(
      ...
      builder: (context, states) {
        ...
        Widget result() {
            late Widget hangupIcon;
            late Widget acceptIcon;

  // Logika menampilkan ikon saat item di-hover

  if (states.isHovering && iscalltype == true) {
    // Tambahkan logika atau widget Icon() yang sesuai untuk "hangup" dan "accept"
    hangupIcon =  GestureDetector(
      onTap: onTap2,
      child:
      Container(
...
child: Row(children: [
    ...
    );  // Ganti dengan ikon accept yang diinginkan
  } else {
    hangupIcon = const SizedBox.shrink(); // Jika tidak di-hover, ikon hangup tidak ditampilkan
    acceptIcon = const SizedBox.shrink(); // Jika tidak di-hover, ikon accept tidak ditampilkan
  }
            ...
            case PaneDisplayMode.open:
              ...
              return ConstrainedBox(
                ...
                child: Row(children: [
                  ...
                  states.isHovering == false && iscalltype == true ?
                  Column(
          ...
          textResult,
                       ...
                       Text("Waiting 120m",style: TextStyle(fontSize: 12),)
        ...
        hangupIcon,
        const SizedBox(width: 8), // Jarak antara ikon
        acceptIcon,
      ],
  ...
  PaneItem copyWith({
    ...
    return PaneItem(
      ...
      onTap: onTap ?? this.onTap,
       onTap2: onTap2 ?? this.onTap2,
         onTap3: onTap3 ?? this.onTap3,
    );
  }
}
